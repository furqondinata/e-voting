               ...
               <form action="<?= site_url('admin/kelas/simpan'); ?>" method="post">
                    <table id="table" width="50%">
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="btn btn-danger btn-sm" id="btn_minus" style="margin-top:10px; margin-left:10px;" disabled><i class="fa fa-minus-circle"></i></button>
                            </td>

                        </tr>
                    </table>
                    <button type="reset" class="btn" style="margin-right:4px;"><i class="fa fa-refresh"></i>Reset</button>
        ...
        $('#btn_tambah_form').on('click', function(){
            $('#table').append(`
                <tr>
                    ...
                    <td>
                        <button type="submit" class="btn btn-danger btn-sm" id="btn_minus" style="margin-top:10px; margin-left:10px;"><i class="fa fa-minus-circle"></i></button>
                    </td>
